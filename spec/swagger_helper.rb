        ...
        schemas: {
          ...
          house: {
            ...
            properties: {
              ...
              name: { type: :string, description: "The house's name.", example: "My home" },
              address: { type: :string, description: "The house's address.", example: "46 rue Paradis, 13006 Marseille" },
              longitude: { type: :float, description: "Coordinates: Longitude", example: "-73.4924,45.5458" },
              latitude: { type: :float, description: "Coordinates: Latitude", example: "-73.4924,45.5458" },
